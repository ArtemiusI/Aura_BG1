...
IF ~~ DO ~SetGlobal("KickedOut","LOCALS",1) LeaveParty() EscapeAreaMove("%bg1_eet_symbol%2301",664,960,E) ActionOverride("c0auin3",EscapeAreaMove("%bg1_eet_symbol%2301",621,921,SE))~ EXIT
END
...
IF ~~ DO ~TakePartyItem("c0ausw01") LeaveParty() SetGlobal("KickedOut","LOCALS",1) EscapeAreaMove("%bg1_eet_symbol%2301",664,960,E) ActionOverride("c0auin3",EscapeAreaMove("%bg1_eet_symbol%2301",621,921,SE))~ EXIT
END

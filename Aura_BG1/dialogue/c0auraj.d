...
IF ~Global("C0AuraSexChange","GLOBAL",2)~ gender2
...
IF ~~ DO ~SetGlobal("C0AuraSexChange","GLOBAL",3)~ EXIT
END
...
IF ~IsGabber(Player1) CombatCounter(0) !Detect([ENEMY]) Global("C0AuraInsulted","GLOBAL",0)~ THEN BEGIN pid
 ...
 + ~GlobalGT("C0AuraQuest","GLOBAL",8)
	Global("C0AuraBandolier","GLOBAL",0)~ + ~You know how to make explosive weapons, right? Could you create some to help us in our battles?~ DO ~SetGlobal("C0AuraBandolier","GLOBAL",1)~ + explosives
...
IF ~~ lantan.name2
SAY ~"Minerva". That was my great-grandmother's name. She was heralded as the greatest mind of the Glimmershine family during her time.~
...
IF ~~ DO ~GiveItemCreate("c0bandol","C0Aura",1,0,0)~ EXIT
END
